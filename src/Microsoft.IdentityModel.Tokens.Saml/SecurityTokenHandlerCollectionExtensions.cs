...
using TokenHandler = Microsoft.IdentityModel.Tokens.SecurityTokenHandler;

namespace Microsoft.IdentityModel.Extensions
{
    /// <summary>
    /// Extensions to <see cref="Microsoft.IdentityModel.Tokens.SecurityTokenHandler"/> that provide support for validating a security token
    ...
    public static class SecurityTokenHandlerCollectionExtensions
    {
        ...
        /// </summary>
        /// <param name="tokenHandlers"><see cref="ICollection<ISecurityTokenValidator>"/>(s) that can 
        ...
        public static ClaimsPrincipal ValidateToken(this SecurityTokenHandlerCollection tokenHandlers, string securityToken, TokenValidationParameters validationParameters, out Microsoft.IdentityModel.Tokens.SecurityToken validatedToken)
        {
            ...
            {
                throw new Microsoft.IdentityModel.Tokens.SecurityTokenValidationException("ErrorMessages.IDX10201");
            }
            else
            {
                throw new Microsoft.IdentityModel.Tokens.SecurityTokenValidationException(string.Format(CultureInfo.InvariantCulture, "ErrorMessages.IDX10201", securityToken));
            }
        }
        ...
        public static ICollection<ISecurityTokenValidator> GetDefaultHandlers()
        {
            return new Collection<ISecurityTokenValidator>
            {
