...
namespace Microsoft.IdentityModel.Tokens
{
    ...
    internal class SecurityKeyResolver : SecurityTokenResolver
    {
        ...
        protected override bool TryResolveTokenCore(System.IdentityModel.Tokens.SecurityKeyIdentifier keyIdentifier, out System.IdentityModel.Tokens.SecurityToken token)
        {
            ...
            {
                System.IdentityModel.Tokens.SecurityKey key = null;
        ...
        private static bool Matches(System.IdentityModel.Tokens.SecurityKeyIdentifierClause keyIdentifierClause, object key, CertMatcher certMatcher, out System.IdentityModel.Tokens.SecurityToken token)
        {
            token = null;
            if (certMatcher != null)
            {
        ...
        private bool ResolvesToSigningToken(System.IdentityModel.Tokens.SecurityKeyIdentifierClause keyIdentifierClause, out System.IdentityModel.Tokens.SecurityKey key, out System.IdentityModel.Tokens.SecurityToken token)
        {
            token = null;
            key = null;
            ...
            {
                key = null;
                //key = _validationParameters.IssuerSigningKeyResolver(token: _securityToken, securityToken: null, kid: null, validationParameters: _validationParameters);
                if (key != null)
                {
